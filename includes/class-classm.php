...
class MW_Class_Management {
    ...
    public function __construct ( $file, $version = '1.0.1' ){
        ...
        add_filter( 'manage_edit-class_columns', array( $this, 'classm_edit_class_columns' )) ;

        add_action( 'manage_class_posts_custom_column', array( $this, 'classm_manage_class_columns'), 10, 2 );
...
//                var_dump($class);
            ...
            meta_key' => '_class'));
                ...
                $cid = $this->super_unique_array($course_ids);
